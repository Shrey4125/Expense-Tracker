...
const defaultForm = { amount: '', source: '', date: '', description: '' };

export const IncomeForm = ({ initial, onSubmit, onCancel, loading }) => {
  ...
  const validate = () => {
    ...
    if (!validateRequired(form.source)) e.source = 'Source is required';
    ...
    <form onSubmit={handleSubmit}>
      ...
      <div style={{ display: 'flex', gap: 12, justifyContent: 'flex-end' }}>
        ...
        <button type="submit" className="btn btn-success" disabled={loading}>
          {loading ? <span className="spinner-sm" /> : <DollarSign size={15} />}
